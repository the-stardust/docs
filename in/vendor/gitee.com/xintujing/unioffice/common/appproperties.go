...
import (
	...
	"gitee.com/xintujing/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("gitee.com/xintujing/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to gitee.com/xintujing/unioffice
